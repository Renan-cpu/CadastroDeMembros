 ...
 * @author Omega
 */
public class ExibirMembros extends javax.swing.JFrame {
    ...
    private void pesquisar() {
        String sql = "select nome as Nome, endereco as Endereço, telefone as Telefone, nascimento as Aniversário, cpf as CPF, batizado as Batizado, tipo as Tipo From membroecolaborador Where tipo = 'membro' ";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExibirMembros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExibirMembros().setVisible(true);
            }
        });
    }
