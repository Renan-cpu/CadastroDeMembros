 ...
 * @author Omega
 */
public class ExibirVisitantes extends javax.swing.JFrame {
    ...
    private void pesquisar() {
        String sql = "select nomeVisitante as Nome, enderecoVisitante as Endereço, telefoneVisitante as Telefone, algumaigreja as AlgumaIgreja from visitante";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExibirVisitantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExibirVisitantes().setVisible(true);
            }
        });
    }
